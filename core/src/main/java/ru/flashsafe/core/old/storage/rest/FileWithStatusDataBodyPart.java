...
public class FileWithStatusDataBodyPart extends FormDataBodyPart {

    private FileWithStatus fileEntity;
     ...
     */
    public FileWithStatusDataBodyPart() {
        super();
    }
     ...
     */
    public FileWithStatusDataBodyPart(final String name, final FileWithStatus fileEntity) {
     ...
     */
    public FileWithStatusDataBodyPart(final String name, final FileWithStatus fileEntity, final MediaType mediaType) throws IllegalArgumentException {
        super();
        super.setName(name);
        ...
        if (mediaType != null) {
            ...
            setFileEntity(fileEntity, predictMediaType(fileEntity.getFile()));
        }
    }
     ...
     */
    public FileWithStatus getFileEntity() {
        return fileEntity;
    }
     ...
     */
    public void setFileEntity(final FileWithStatus fileEntity) {
     ...
     */
    public void setFileEntity(final FileWithStatus fileEntity, final MediaType mediaType) {
        ...
        if (fileEntity != null) {
            ...
            builder.fileName(fileEntity.getFile().getName());
            if (fileEntity.getFile().exists()) {
                builder.size(fileEntity.getFile().length());
                builder.modificationDate(new Date(fileEntity.getFile().lastModified()));
            }
    ...
    protected MediaType predictMediaType() {
        return predictMediaType(getFileEntity().getFile());
    }

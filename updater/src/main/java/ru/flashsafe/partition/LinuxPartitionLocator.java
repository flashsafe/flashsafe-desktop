...
public class LinuxPartitionLocator extends BasePartitionLocator implements PartitionLocator {
    ...
    protected boolean verifyPartition(String identifier, Path dataPartitionRoot) {
        // TODO add verification process (use data from token, flashsafe web
        // service)
        return true;
    }
